"""
Django settings for event_m project.
...
SECRET_KEY = 'django-insecure-dsp#c0a!e(u9fits$i!1fd$0jd0hi&fs$btnsq_@7@1%xm-ok8'
...
WSGI_APPLICATION = 'event_m.wsgi.application'
...
# settings.py
LOGIN_URL = '/login/'  # Update this to the path of your login URL
